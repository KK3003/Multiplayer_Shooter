...
/// <summary>
/// Guns that fire singel bullet at a time
/// </summary>
public class SingelShotGun : Gun
{
    ...
    void Shoot()
    {
        ...
        {
            hit.collider.gameObject.GetComponent<IDamageable>()?.TakeDamage(((GunInformation)itemInfo).damage);
